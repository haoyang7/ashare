...
import com.haoyoung.ashare.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class AshareSentinelInvocationHandler implements InvocationHandler {
	...
	AshareSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			AshareSentinelInvocationHandler other = (AshareSentinelInvocationHandler) obj;
